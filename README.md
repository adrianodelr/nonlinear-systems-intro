...
- If all the eigenvalues of the linarized system (at the fixed point) lie off the imaginary axis (i.e. $Re(\lambda_i)  0$ for $i = 1,\dots,n$), the fixed point is **hyperbolic**
