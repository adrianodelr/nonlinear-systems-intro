...
I've also documented all the [plotting functions](utils.jl) so that you can experiment with the function parameters. 
...
## Concepts and examples for linear systems (applicable to nonlinear systems)
